...
const Banner = () => {
    return (
       <section className='flex justify-between items-center container mx-20'>
        <div className=''>
            <h2 className='inter text-6xl font-extrabold'>
