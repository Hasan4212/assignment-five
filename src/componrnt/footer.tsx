...
const Footer = () => {
    return ( 
<section>
       <div className='jakarta flex items-start align-middle justify-between  mx-20 my-20'>
        <div> 
<img src={logo} alt="" /> 
<p className=' my-4 '>Curated tools, technologies, and resources for developers building <br />
modern software.</p> 
...
<div className='jakarta flex items-center justify-between my-4 container mx-auto'>
